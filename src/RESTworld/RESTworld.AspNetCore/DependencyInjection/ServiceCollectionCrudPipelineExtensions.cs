...
public static class ServiceCollectionCrudPipelineExtensions
{
    ...
    public static IServiceCollection AddCrudPipeline<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>(this IServiceCollection services, ApiVersion? apiVersion = null, bool isDeprecated = false)
    ...
    {
        services.AddScoped<ICrudServiceBase<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>, CrudServiceBase<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>>();
        services.AddForeignKeyForFormTo<TGetListDto>();
        RestControllerFeatureProvider.AddCrudController<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>();
        services.Configure<MvcApiVersioningOptions>(options =>
        {
            var controllerConvention = options.Conventions.Controller<CrudController<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>>();
    ...
    /// </param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
    public static IServiceCollection AddCrudPipelineWithAuthorization<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto, TAuthorizationHandler>(this IServiceCollection services, IConfiguration configuration, ApiVersion? apiVersion = null, bool isDeprecated = false)
        where TContext : DbContextBase
        where TEntity : ConcurrentEntityBase
        where TQueryDto : class
        where TGetListDto : ConcurrentDtoBase
    ...
    {
        services.AddCrudPipeline<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>(apiVersion, isDeprecated);
        services.AddCrudAuthorizationHandler<TAuthorizationHandler, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>(configuration);
    ...
    /// <param name="services">The <see cref="IServiceCollection"/> to add services to.</param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
    public static IServiceCollection AddCrudPipelineWithCustomService<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto, TService>(this IServiceCollection services)
        where TContext : DbContextBase
        where TEntity : ConcurrentEntityBase
        where TQueryDto : class
        where TGetListDto : ConcurrentDtoBase
    ...
    {
        services.AddScoped<ICrudServiceBase<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>, TService>();
        RestControllerFeatureProvider.AddCrudController<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>();
        services.AddForeignKeyForFormTo<TGetListDto>();
    ...
    /// </param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
    public static IServiceCollection AddCrudPipelineWithCustomServiceAndAuthorization<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto, TService, TAuthorizationHandler>(this IServiceCollection services, IConfiguration configuration)
        where TContext : DbContextBase
        where TEntity : ConcurrentEntityBase
        where TQueryDto : class
        where TGetListDto : ConcurrentDtoBase
        ...
        where TAuthorizationHandler : class, ICrudAuthorizationHandler<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>
    {
        services.AddCrudPipelineWithCustomService<TContext, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto, TService>();
        services.AddCrudAuthorizationHandler<TAuthorizationHandler, TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto>(configuration);
