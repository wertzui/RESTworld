...
public class RestWorldOptions
{
    ...
    /// <summary>
    /// Disables all <see cref="Business.Authorization.Abstractions.ICrudAuthorizationHandler{TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto}"/>s so they wont be called.
