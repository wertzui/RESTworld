...
/// Is used in <see cref="ICrudServiceBase{TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto}"/>s.
...
/// <typeparam name="TQueryDto">The type of the DTO which is used for querying.</typeparam>
...
public interface ICrudAuthorizationHandler<TEntity, TCreateDto, TQueryDto, TGetListDto, TGetFullDto, TUpdateDto> :
    ICreateAuthorizationHandler<TEntity, TCreateDto, TGetFullDto>,
    IReadAuthorizationHandler<TEntity, TQueryDto, TGetListDto, TGetFullDto>,
