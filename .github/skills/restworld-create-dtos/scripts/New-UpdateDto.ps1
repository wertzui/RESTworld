<#
.SYNOPSIS
    Creates a RESTworld TUpdateDto file for the given entity.

.DESCRIPTION
    Generates a C# TUpdateDto class (extends ConcurrentDtoBase) in the Dtos/<EntityName>/ subfolder
    of the specified .Common project folder.
    Provides Id + Timestamp via the base class.
    Navigation properties must NOT be included in -Properties for this DTO type.
...
.PARAMETER Properties
    ...
    Do NOT include navigation properties here — UpdateDto never has them.
...
.EXAMPLE
    ...
    .\New-UpdateDto.ps1 -EntityName "Post" -CommonFolder "C:\Repos\Blog\Blog.Common" -Properties $props
#>
...
$outputFile = Join-Path $dtosFolder "${EntityName}UpdateDto.cs"
...
public class ${EntityName}UpdateDto : ConcurrentDtoBase
{$propertyBlock}
"@
